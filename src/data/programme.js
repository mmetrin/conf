export const topics = [
  ...
  },
  {
    ...
    description:
      "Одна бизнес-задача пройдёт через экосистему рекламных решений — от самостоятельного запуска до мультитач-атрибуции",
  },
];
export const slots = [
  {
  ...
  {
    time: "18:00 – 20:30",
    title: "Открытие и деловая программа",
    guest: false,
  },
  {
    time: "19:50 – 20:30",
    title: "Вечерняя программа и нетворкинг",
    guest: false,
  },
  {
    time: "20:30 – 21:30",
    title: "Специальный музыкальный гость",
    guest: true,
  },
  {
    time: "21:30 – 23:00",
